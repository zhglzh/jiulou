...
<script>  
    var config = {  
        ...
        dataAlign: "left",  
        indentation: "20",  
        folderOpenIcon: "resource/treegrid/folder-image-blue-icon.png",
        folderCloseIcon: "resource/treegrid/folder-close-blue-icon.png",
        defaultLeafIcon: "resource/treegrid/folder-blue-icon.png",
